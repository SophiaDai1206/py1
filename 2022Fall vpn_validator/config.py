...
class Configuration:
    ...
    def __init__(self) -> None:
        """Setup for the class of configuration
        ...
        # version info
        # this should be change when we update centinel
        version_info = {'version': '0.1.5.7'}  # centinel.__version__}
    ...
    def parse_config(self, config_file: str) -> None:
        ...
        Args:
            config_file: The given config file
    ...
    def update(self, old: str, backup_path=None) -> None:
        """Update the old configuration file with new values.

        Args:
            old: old configuration file to update.
            backup_path: path to write a backup of the old config file.
    ...
    def write_out_config(self, config_file: str) -> None:
